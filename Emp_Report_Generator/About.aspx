...
<body  style="width: 923px; height: 713px" bgcolor="#ff6600">
 <center>
  ...
  <h1 align="center" 
        ...
        style="font-size: 60px; font-family: 'Microsoft JhengHei Light'; color: #FFFFFF; font-weight: lighter; width: 1131px; margin-left: 0px;">
      Employee Report Generator</h1>
    <br /><br />
    <div style="height: 417px; width: 351px; background-color: #ff6600;" 
        ;align="center" class="centerBlock">
    <br />
     <h2 class="headertekst" align="center" 
            
            style="font-family: 'Microsoft JhengHei Light'; font-size: xx-large; font-weight: lighter; color: #FFFFFF; text-decoration: underline" >Sign In</h2>
     <br />
    <asp:Label ID="lb1" runat="server" class="font1" ForeColor="White" 
            Font-Names="Microsoft New Tai Lue" ></asp:Label><br />
    <br /><br />
     <asp:Label ID="Label1" runat="server" Text="Name"  Width="100px" class="font1" 
            ForeColor="White" Font-Names="Microsoft New Tai Lue"></asp:Label>
        ...
        <asp:Label ID="Label2" runat="server" Text="Password" Width="100px" 
            class="font1" ForeColor="White" Font-Names="Microsoft New Tai Lue"></asp:Label>
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Default.aspx"
                       class="font1" ForeColor="White">Click here to Register</asp:HyperLink>
    </div>
