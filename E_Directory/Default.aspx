...
<body bgcolor="#ff6600">
    <form id="form1" runat="server">
      <h1 align="center" 
          ...
          style="font-size: 60px; font-family: 'Microsoft JhengHei Light'; color: #000000; font-weight: lighter; width: 1290px; margin-left: 0px;">E-Directory</h1>
    <div align="center">
    <table align="center">
            <tr>
                <td colspan="3">
                    <h3 class="headertekst" 
                        ...
                        style="font-family: &quot;Microsoft JhengHei UI Light&quot;; color: #000000; font-size: 40px; font-weight: lighter; text-decoration: underline" >
                         Registration </h3>
                </td>
            </tr>
            <tr>
                <td style="color: #FFFFFF; font-family: 'Microsoft YaHei UI Light'; font-weight: lighter">
                 ...
                 <asp:Label ID="Label1" runat="server" Text="UserName:" Width="100px" class="font1" 
                        Font-Names="Microsoft YaHei UI Light" ForeColor="Black"></asp:Label>
                    </td>
                <td style="color: #FFFFFF; font-family: 'Microsoft YaHei UI Light'; font-weight: lighter">
                ...
                <td style="color: #FFFFFF; font-family: 'Microsoft YaHei UI Light'; font-weight: lighter">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                        ErrorMessage="Enter UserName" ControlToValidate="txt_UserName" 
                        ForeColor="Black"></asp:RequiredFieldValidator> </td>
            </tr>
            <tr>
                <td>
                ...
                <td><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                        ...
                        Font-Names="Microsoft New Tai Lue" ForeColor="Black"></asp:RequiredFieldValidator> </td>
            </tr>
            ...
            <td></td><br /><br />
                <td>
                    <asp:Button ID="btn_register" runat="server" class="dropbtn" Text="Register"
                        onclick="btn_register_Click" BackColor="#FF6600" BorderColor="Black" 
                        BorderStyle="Solid" ForeColor="Black" />
 
                </td>
                <td><asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/About.aspx"
                        class="font1" Font-Names="Microsoft YaHei UI Light" ForeColor="Black">Click here to Login</asp:HyperLink></td>
